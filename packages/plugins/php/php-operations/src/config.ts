...
/**
 * @description This plugin generates PHP `class` based on your GraphQL operations.
 */
export interface PhpOperationsRawPluginConfig extends RawClientSideBasePluginConfig {
  /**
